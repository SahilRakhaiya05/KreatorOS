---
name: kreatoros
description: Development conventions and patterns for KreatorOS. JavaScript project with conventional commits.
---

# KreatorOS Conventions

> Generated from the repo's internal workflow bundle on 2026-03-20

## Overview

This skill teaches Claude the development patterns and conventions used in KreatorOS.
...
```text
fix: auto-detect KreatorOS root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by KreatorOS tools. Review and customize as needed for your team.*
