...
> Project-specific rules for the KreatorOS codebase. Extends common rules.
...
- Use `run-with-flags.js` wrapper for all hooks so `KREATOROS_HOOK_PROFILE` and `KREATOROS_DISABLED_HOOKS` runtime gating works
